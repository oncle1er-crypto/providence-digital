...
export function AdmissionsCTA() {
  return (
    <section className="container-page py-8">
      <Reveal variant="zoom" className="grid gap-6 rounded-3xl bg-primary p-8 text-primary-foreground shadow-xl sm:p-10 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-center">
