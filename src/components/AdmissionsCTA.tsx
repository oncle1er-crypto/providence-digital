      ...
      >
        <div className="min-w-0">
          ...
          <p className="mt-3 max-w-xl text-sm text-primary-foreground/85">
            Les demandes de préinscription sont ouvertes pour la maternelle, le primaire, le collège et le
            lycée. La préinscription en ligne est présentée ici à titre de démonstration : la validation se fait
